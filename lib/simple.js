...
const wm = typeof global?.wm !== 'undefined' ? global.wm : 'Swill • 2025'
...
END:VCARD`.trim()
  ...
  }) // cierre Object.defineProperties de sock
        ...
        try {
          ...
          return Object.defineProperties(
            JSON.parse(JSON.stringify(typeof q === 'string' ? { text: q } : q || {})),
            {
              ...
              copy: {
                value() {
                  const M = baileys.proto
                  return smsg(self.conn, M.WebMessageInfo.fromObject(M.WebMessageInfo.toObject(this.vM)))
                },
                enumerable: true,
              },

...
// Middleware de permisos SW SYSTEM — versión final
...
function loadPluginPermissions() {
  ...
  try {
    ...
    if (CACHE.pluginPermissions && CACHE.pluginPermissionsMtime === stat)
      return CACHE.pluginPermissions
...
// (No lo estás usando activamente ahora, pero queda para futuro)

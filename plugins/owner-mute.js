...
/* ============================
   EXPORTS
============================ */
export { shadowMap, saveShadowbans, scheduleUnshadow }

// Función utilitaria para aplicar shadowban invisible desde otros plugins
export async function applyShadowban(conn, target, duration = 10, actor = 'system', chat = null) {
  ...
  saveShadowbans()
  scheduleUnshadow(jid, expiresAt - Date.now(), conn)
  auditLog(`APPLY-SHADOW ${jid} by ${actor} duration=${duration}m`)
}
